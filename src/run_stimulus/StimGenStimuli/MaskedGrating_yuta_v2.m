function MaskedGrating_yuta_v2(trials)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% function [trials] = MaskedGrating_yuta(stimType,table)
%  if nargin<1
%     table = {'Spatial Frequency (cpd)', .1, .1, .1;...
%               'Temporal Frequency (cps)', 3, 1, 3;...
%               'Diameter (deg)', 15, 5, 15;...
%               'Contrast (start,end,numsteps)', 1, 1, 1;...
%               'Orientation', 0, 90, 270;...
%               'Mask Center XY (complex num, degs)', -10-10i, 3, 10+10i;...
%               'Mask Type (Sq., Circ., Gauss)', 'Circular',[],[];...
%               'Timing (delay,duration,wait) (s)', 0.1, 0.33, 0.05;...
%               'Blank', 0, [], [];...
%               'Randomize', 1, [], [];...
%               'Interleave', 0, [], [];...
%               'Repeats', 0, [], []};
...
% diameter of the mask
 ...
 %%%%%%%%%%%%%%% OBTAIN GRATING PARAMS FROM TRIALSSTRUCT %%%%%%%%%%%%%%%%%%
    ...
    if ~strcmp(trials(trial).Stimulus_Type, 'Blank')
        ...
        x = real(trials(trial).Mask_Center_XY(1))*(1/degPerPix)+...
                    monitorInfo.screenSizePixX/2;
        y = -1*imag(trials(trial).Mask_Center_XY(1))*(1/degPerPix)+...
