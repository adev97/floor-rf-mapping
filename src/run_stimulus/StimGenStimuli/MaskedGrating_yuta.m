...
function [trials] = MaskedGrating_yuta(stimType,table)
 if nargin<1
    table = {'Spatial Frequency (cpd)', .1, .1, .1;...
              ...
              'Mask Center X (degs)', -10, 20, 10;...
              'Mask Center Y (degs)', -10, 20, 10;...
...
% diameter of the mask
 ...
 %%%%%%%%%%%%%%% OBTAIN GRATING PARAMS FROM TRIALSSTRUCT %%%%%%%%%%%%%%%%%%
    ...
    if ~strcmp(trials(trial).Stimulus_Type, 'Blank')
        ...
        x = (trials(trial).Mask_Center_X(1))*(1/degPerPix)+...
                    monitorInfo.screenSizePixX/2;
        y = -1*trials(trial).Mask_Center_Y(1)*(1/degPerPix)+...
