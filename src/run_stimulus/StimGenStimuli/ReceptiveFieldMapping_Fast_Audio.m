...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ReceptiveFieldMapping_Fast_Audio(trials,audioXdeg,audioYdeg)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
amp=0.1;
freq = 6000;
finalsound=amp*sin(2*pi* freq.*values);

% sound(finalsound,fs,24);
%% assign audio trials
trial_num = length(trials);
for i=1:trial_num 
    curXdeg = trials(i).Square_PositionX;
    curYdeg = trials(i).Square_PositionY;
    curL = trials(i).Square_Luminance;
    trials(i).Audio = false;
    if any(curXdeg==audioXdeg) && any(curYdeg==audioYdeg) && curL ==0 && i>1
        trials(i).Audio = true;
    end
end
% aa =0;
...
%%%%%%%%%%%%%%%%%%%% GET STIMULUS TIMING INFORMATION %%%%%%%%%%%%%%%%%%%%%%
    ...
    durationframes = trials(trial).Timing(2);
...
%                 srcRect = [0 0 monitorInfo.screenSizePixX monitorInfo.screenSizePixY];
                ...
                % LeftBoxStim(w, screenRect, whitePix);
