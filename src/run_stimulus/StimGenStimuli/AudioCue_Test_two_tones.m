...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function AudioCue_Test_two_tones(trials,s)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%            imMtrx = 20*ones(monitorInfo.screenSizePixX,monitorInfo.screenSizePixY);
...
%             
%                 squares(trial)=Screen('OpenOffscreenWindow', w, grayPix, screenRect);
%                 Screen('FillOval', squares(trial), white, [0 0 2 2]*(i-1));
%             
%             
%             % show movie
%             
%                 Screen('CopyWindow',squares(trial),window,rect,rect);
%                 Screen('Flip', window);
%             
%             Screen('CloseAll');
%             
...
%%%%%%%%%%%%%%%%%%%% DRAW DELAY GRAY SCREEN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
    ...
    % to take possible timing jitter or roundoff-errors into account.
        while (vbl < delayTime)
            ...
            elseif trials(trial).Audio_Cue==2
                 TopRightBoxStim(w, screenRect, blackPix);     
            end
...
%%%%%%%%%%%%%%%%%%%%%%%%%% DRAW GRATING TEXTURE %%%%%%%%%%%%%%%%%%%%%%%%%%%         
        ...
        if ~strcmp(trials(trial).Stimulus_Type, 'Blank')
            ...
            TargetOn = trials(trial).Square_PositionX == trials(trial).Audio_TargetX ...
                && trials(trial).Square_PositionY == trials(trial).Audio_TargetY;
            DistractOn = trials(trial).Square_PositionX == trials(trial).Audio_DistractX ...
                && trials(trial).Square_PositionY == trials(trial).Audio_DistractY;
...
%                 srcRect = [0 0 monitorInfo.screenSizePixX monitorInfo.screenSizePixY];
                ...
                if trials(trial).Audio_Cue==1 && delay==0
                    TopLeftBoxStim(w, screenRect, blackPix);
                elseif trials(trial).Audio_Cue==2 && delay==0
                    TopRightBoxStim(w, screenRect, blackPix);    
                end
            ...
            while (vbl < runtime)
                ...
                LeftBoxStim(w, screenRect, blackPix);
                FlipCheck(w, screenRect, [blackPix, whitePix], n);
                %RightBoxStim(w, screenRect, whitePix);
