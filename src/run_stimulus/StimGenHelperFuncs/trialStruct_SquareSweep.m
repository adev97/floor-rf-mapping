...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [trials] = trialStruct_SquareSweep( stimType, table)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:(constants.Repeats+1)
        ...
        % RANDOMIZE AND NO INTERLEAVE
                ...
                for nn=1:allnum
                    if p(nn)==1
                        trial_arrays_now = trial_arrays;
                        trial_arrays_now(omitIdx,[1,2]) = [100 100];
                    else
                        trial_arrays_now = trial_arrays;
                    end
                    new_trial_arrays = [new_trial_arrays; trial_arrays_now];
                end
