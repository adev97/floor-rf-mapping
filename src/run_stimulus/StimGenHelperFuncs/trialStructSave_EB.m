...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function trialStructSave_EB(trials,savename)
...
if time(2)<10
    date = [mat2str(time(1)),'0',mat2str(time(2)),mat2str(time(3))];
    if time(3)<10
        date = [mat2str(time(1)),'0',mat2str(time(2)),'0',mat2str(time(3))];
    end    
elseif time(3)<10
    date = [mat2str(time(1)),mat2str(time(2)),'0',mat2str(time(3))];
else
    date = [mat2str(time(1)),mat2str(time(2)),mat2str(time(3))];
end
