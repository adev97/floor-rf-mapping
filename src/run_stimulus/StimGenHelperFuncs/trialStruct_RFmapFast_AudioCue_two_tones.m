...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [trials] = trialStruct_RFmapFast_AudioCue_two_tones( stimType, table)
...
audioIdx_low_tar = trial_arrays(:,1)==constants.Audio_TargetX & trial_arrays(:,2)==constants.Audio_TargetY;
trial_arrays(audioIdx_low_tar,3)=1;

audioIdx_high_dis = trial_arrays(:,1)==constants.Audio_DistractX & trial_arrays(:,2)==constants.Audio_DistractY;
trial_arrays(audioIdx_high_dis,3)=2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:(constants.Repeats+1)
        ...
        if constants.Randomize == 1 && constants.Interleave ~=1
                ...
                new_trial_arrays = repmat(trial_arrays,[AVnum-1,1]);
                onlyV_trials = repmat([constants.Audio_TargetX, constants.Audio_TargetY, 0; ...
                    constants.Audio_DistractX, constants.Audio_DistractY, 0],[Vnum,1]);
                onlyA_trials = repmat([100 100 1; 100 100 2],[Anum,1]);
                
                new_trial_arrays = [new_trial_arrays; onlyV_trials; onlyA_trials];

                randIndex = randperm(size(new_trial_arrays,1));

                new_trial_arrays = [trial_arrays; new_trial_arrays(randIndex,:)];
